				...
				<div class="col-sm-12">
					<div class="form-group">
						...
						<textarea name="message" id="editor">
                            <!-- <p>Dear -->
								 <?php 
							//echo $applicant['applicant_full_name'];
							 ?>
							 <!-- </p> -->
...
if(isset($_POST['submit']))
{
	...
	";
	$headers = "From: IMISSUSGemail@example.com";
   ...
   // $headers .= "\nMIME-Version: 1.0\n" . "Content-Type: text/html;charset=UTF-8\n" . " boundary=\"{$mime_boundary}\"";
    ...
    foreach ($email_array as $email) {
		if (mail($email, $subject, $message, $headers)) {
			echo '<script>alert("Email Sent successfully");window.location.href="list.php";</script>';
		} else {
			echo "failed";
		}
	}
