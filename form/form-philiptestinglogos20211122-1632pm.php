...
<body>
        ...
        <div align="center">
          <div style="padding:30px 0 60px 0">
            <img src="logo/awhl.png" width="40%" height="40%">
          </div>
        </div>
    	</div>
		...
		<div class="row mt-2 mb-2">   
			...
			<img src="logo/natrahea.jpg" width="100%" style="padding-bottom: 30px;">
			</div>
			<div class="col-md-3 col-6 text-center">
			<img src="logo/haach.jpg" width="100%" style="padding-bottom: 30px">
			</div>
			<div class="col-md-3 col-6 text-center">
			<img src="logo/drhaach.jpg" width="100%" style="padding-bottom: 30px">
			</div>
		</div>
      
		<div class="row mt-2 mb-2">   
			<div class="col-md-3 col-6 text-center">
			<img src="logo/BC.jpg" width="100%" style="padding-bottom: 30px">
			</div>
			<div class="col-md-3 col-6 text-center">
			<img src="logo/FIL.jpg" width="100%" style="padding-bottom: 30px">
			</div>
			<div class="col-md-3 col-6 text-center">
			<img style="vertical-align: bottom" src="logo/physiomed.jpg" width="100%" style="padding-bottom: 30px">
			</div>
      
		<div class="row mt-2 mb-2">   
			<div class="col-md-3 col-6 text-center">
			<img src="logo/passage.jpg" width="100%" style="padding-bottom: 60px">
			</div>
			<div class="col-md-3 col-6 text-center">
			<img style="vertical-align: middle" src="logo/Trichomed.jpg" width="100%" style="padding-bottom: 60px">
			</div>
			<div class="col-md-3 col-6 text-center">
			<img src="logo/TCC.jpg" width="100%" style="padding-bottom: 30px">
			</div>
		</div>
